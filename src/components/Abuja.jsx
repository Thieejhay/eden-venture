      ...
      <div className='flex flex-col'>
        ...
        <div className='flex lg:flex-row flex-col px-4 lg:px-4 lg:gap-12 gap-4 justify-center lg:py-10 py-5 bg-[#6100c1]/90'>
          <span className='flex flex-col lg:w-[42rem] text-lg leading-6 text-[#6100c1]/90 gap-2'>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>10:00 am: Attendee Arrival & registration</span>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>10:30 am: Keynote speech</span>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>11: 15 am:  Panel Discussion: "Policy Pathways: Reforming Maternal, Newborn, and Child Health in Nigeria"</span>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>12:00 pm: Refreshments and Break</span>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>12:30 pm- 1:00pm: Deep Dive: “Nigeria’s MNCH Landscape: Saving 2 Million Lives by 2030</span>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>1:30pm  - Panel Discussion- Social Impact x Innovation: Tackling women’s healthcare in Nigeria</span>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>2:30 pm: Music Performance by Falana</span>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>3:00 pm: Call to Action</span>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>3:30 pm: Closing Remarks & Call to Action</span>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>3:30 pm - 5:00 pm: Networking & Medical Screening </span>
            <span className='px-4 py-1 bg-[#E2E7E9] rounded-xl hover:bg-transparent hover:text-[#E2E7E9]/80 transition duration-300'>10:00 am - 6:00 pm: Medical screenings (Cervical Cancer, Sickle Cell, PCOS, General women’s health)</span>
          </span>
        ...
        <div className='flex justify-center items-center mb-6'><Link to='/register'><span className='flex items-center lg:px-12 px-3 lg:py-5 py-2 border-none rounded-md bg-[#6100c1]/70 w-fit text-3xl text-[#E2E7E9]/90 uppercase'>Register</span></Link></div>
      </div>
