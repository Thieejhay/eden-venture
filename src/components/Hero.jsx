...
const Hero = () => {
  ...
  return (
    <motion.div className="flex text-white relative h-screen w-screen font-barlow flex-col">
      ...
      <span className='w-screen font-semibold flex items-center justify-center -mt-72 lg:-mt-[13rem]'><span className='lg:text-7xl text-2xl text-[#E2E7E9]/95'>{imageSlide[currentSlide].title}</span></span>
