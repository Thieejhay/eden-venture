...
const Hero = () => {
  ...
  return (
    <motion.div className="flex text-white relative h-screen w-screen font-barlow flex-col">
      ...
      <span className='w-screen font-semibold flex items-center justify-center -mt-72 lg:-mt-[13rem]'><span className='bg-[#000000]/20 p-3 rounded-lg lg:w-[70%] flex items-center justify-center shadow-[0_35px_35px_rgba(0,0,0,0.25)]'><span className='lg:text-7xl text-2xl'>{imageSlide[currentSlide].title}</span></span></span>
