...
const Hero = () => {
  ...
  return (
    <motion.div className="flex text-white relative h-screen w-screen font-barlow flex-col">
      ...
      <span className='w-screen font-semibold flex items-center justify-center -mt-72 lg:-mt-[13rem]'><span className='bg-[#000000]/20 p-3 rounded-lg lg:w-[70%] flex items-center justify-center shadow-[0_35px_35px_rgba(0,0,0,0.25)]'><span className='lg:text-7xl text-3xl'>{imageSlide[currentSlide].title}</span></span></span>
      <span className='flex lg:z-50 z-10 absolute lg:top-[90%] top-[80%] left-[50%] -translate-x-2/4 -translate-y-2/4'>
        {
