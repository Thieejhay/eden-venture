  ...
  return (
    <div className='flex lg:px-32 lg:py-24 px-6 py-12 flex-col lg:gap-8 gap-0'>
      ...
      <div className='lg:flex hidden justify-center items-center lg:gap-24 gap-4'>
        ...
        <div className='lg:w-[8rem] lg:h-[8rem] w-24 h-24 flex justify-center items-center'><img src={Logo5} alt='' className='lg:w-[5rem] w-12 lg:h-[5rem] h-12 flex items-center'/></div>
      ...
      <div className='lg:flex hidden justify-center items-center lg:gap-24 gap-4'>
        <div className='lg:w-[8rem] lg:h-[8rem] w-24 h-24 flex justify-center items-center'><img src={Logo20} alt='' className='lg:w-[7rem] w-12 lg:h-[7rem] h-12 flex items-center'/></div>
      ...
      <div className='lg:flex hidden justify-center items-center lg:gap-24 gap-4'>
        <div className='lg:w-[8rem] lg:h-[8rem] w-24 h-24 flex justify-center items-center'><img src={Logo9} alt='' className='lg:w-[4rem] w-12 lg:h-[6rem] h-12 flex items-center'/></div>
        <div className='lg:w-[8rem] lg:h-[8rem] w-24 h-24 flex justify-center items-center'><img src={Logo15} alt='' className='lg:w-[4rem] w-12 lg:h-[2rem] h-12 flex items-center'/></div>
        ...
        <div className='lg:w-[8rem] lg:h-[8rem] w-24 h-24 flex justify-center items-center'><img src={Logo19} alt='' className='lg:w-[6rem] w-12 lg:h-[8rem] h-12 flex items-center'/></div>
        <div className='lg:w-[8rem] lg:h-[8rem] w-24 h-24 flex justify-center items-center'><img src={Logo16} alt='' className='lg:w-[7rem] w-12 lg:h-[3rem] h-12 flex items-center'/></div>
      </div>
