...
const Creators = () => {
  ...
  return (
    <div className='flex relative bg-gray-200/20 py-12 lg:py-16 px-6 w-screen font-barlow'>
        <div className='flex w-full h-[42rem] lg:h-[27rem]'>
            <div className='flex flex-col lg:w-[30%] w-[50%] bg-[#055594] rounded-l-2xl items-center justify-center'>
                <span className='flex absolute top-16 left-0'><img src={Design2} alt='' className='w-[15rem] h-[8rem]'></img></span>
            ...
            <div className='flex flex-col space-y-4 lg:w-[70%] w-[50%] bg-gray-400/20 rounded-r-2xl lg:px-4 px-1 justify-center gap-12'>
                <span className='flex lg:gap-3 gap-1 w-[50rem]'>
                    ...
                    <span className='text-2xl font-light text-justify text-[#000000]/70'>{createSlide[currentSlide].text}</span>
                </span>
                <span className='flex lg:gap-3 gap-1 w-[50rem]'>
                    <span><BsDot className='text-[#0CB3A2] w-6 h-6'/></span>
                    <span className='text-2xl font-light text-justify text-[#000000]/70'>{createSlide[currentSlide].text1}</span>
                </span>
