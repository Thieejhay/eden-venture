    ...
    <div className='flex flex-col relative bg-gray-200/20 w-screen font-barlow'>
        <div className='py-6 lg:py-5 px-3 lg:px-5'>
          <div className='flex w-full h-[37rem] lg:h-[27rem]'>
            <div className='flex flex-col lg:w-[30%] w-[45%] bg-[#1F389F]/95 rounded-l-2xl lg:px-8 px-1 justify-center'>
                ...
                <span className='lg:text-4xl text-lg font-extrabold text-[#ffffff] lg:tracking-wide'>#WEECreateAfrica</span>
