    ...
    <div className='flex flex-col relative bg-gray-200/20 w-screen font-barlow'>
        <div className='py-6 lg:py-5 px-3 lg:px-5'>
          <div className='flex w-full h-[37rem] lg:h-[27rem]'>
            <div className='flex flex-col lg:w-[30%] w-[45%] bg-[#1F389F]/95 items-center rounded-l-2xl lg:px-8 px-2 justify-center'>
                <span className='flex absolute top-4 lg:left-0 -left-6'><img src={Design2} alt='' className='lg:w-[15rem] lg:h-[8rem] w-36 h-36'></img></span>
                <span className='lg:text-4xl text-base font-extrabold text-[#ffffff] lg:tracking-wide'>#WEECreateAfrica</span>
                <div className='flex lg:flex-row flex-col ml-3 lg:ml-0 lg:gap-1'>
                  <span className='text-base font-normal text-[#ffffff] lg:tracking-wide'>Women Economic</span>
                  <span className='text-base font-normal text-[#ffffff] lg:tracking-wide'>Empowerment x </span>
                  <span className='text-base font-normal text-[#ffffff] lg:tracking-wide'> Creators</span>
                </div>
            </div>
