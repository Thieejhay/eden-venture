    ...
    <motion.div className='flex'>
      <div className='bg-[#000000]/90 flex relative h-screen w-screen font-barlow'>
        ...
        <div className='flex flex-col gap-3 z-10 absolute bottom-6 lg:left-24 left-3'>
          ...
          <span className='lg:text-7xl text-3xl font-bold lg:font-extrabold tracking-tight text-[#E2E7E9]/90 uppercase'>supporting and</span>
          ...
          <span className='lg:text-7xl text-3xl font-bold lg:font-extrabold tracking-tight text-[#E2E7E9]/90 uppercase'>underserved.</span>
        </div>
      </div>
    </motion.div>
  )
