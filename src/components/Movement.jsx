...
const Movement = () => {
  ...
  return (
    <div className='flex flex-col bg-[#055594] w-screen px-4 lg:px-0 mt-8'>
        <div className='flex items-center justify-center w-full lg:gap-6 gap-2'>
            ...
            <div className='flex flex-col items-center lg:h-24 h-20 py-2'>
                <span className='uppercase text-lg font-normal text-white'>Join the movement</span>
        ...
        <div className='flex w-screen h-12 bg-[#0CB3A2] items-center justify-center'>
        </div>
    </div>
  )
}
